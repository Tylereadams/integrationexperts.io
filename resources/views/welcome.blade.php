    ...
    <header id="header">
        ...
        <div class="content">
            <div class="inner">
                ...
                <p>We're here to simplify your software needs by integrating external vendors and applications to help you run your business efficiently and effective.</p>
            </div>
        </div>
        <nav>
            <ul>
